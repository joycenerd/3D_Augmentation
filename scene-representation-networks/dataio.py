...
class SceneInstanceDataset():
    ...
    def __getitem__(self, idx):
        # print("idx: ", self.instance_idx, " | dir: ", self.instance_dir)
        ...
        input_img_path = np.random.choice(self.color_paths, 1, replace=False)[0]
        input_img = data_util.load_rgb(input_img_path, sidelength=self.img_sidelength)
...
class SceneClassDataset(torch.utils.data.Dataset):
    ...
    def __init__(self,
        ...
        self.instance_dirs = self.load_data()
